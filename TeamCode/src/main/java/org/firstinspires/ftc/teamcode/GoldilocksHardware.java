...
public class GoldilocksHardware {
    ...
    public static final double ccLeftClose = (10./255.);        //cowcatcher open/close values
    public static final double ccRightClose = (212./255.);
    public static final double ccLeftOpen = (200./255.);
    public static final double ccRightOpen = (50./255.);

    public static final double particleLiftUp = (190./255.);    //up/down particleLift positions
